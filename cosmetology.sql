/*
 ...
 Source Schema         : cosmetology

 Target Server Type    : MySQL
 Target Server Version : 80032
 File Encoding         : 65001

 Date: 15/07/2023 17:32:55
*/
...
CREATE TABLE `business`  (
  ...
  `busname` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商家名称',
  `busaddress` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商家地址',
  `busexplain` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商家介绍',
  `bustell` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商家电话',
  `servertime` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '服务时间',
...
-- Records of business
-- ----------------------------
INSERT INTO `business` VALUES (2, '源码美容美发111', '成都市武侯区肖家河大厦三楼25教室', '源码美容美发养生馆是集美容.美发.纹绣.养生为一体的专业服务团队。一楼美发厅拥有专业发型设计师8人为您提供新潮时尚的发型设计', '028-35647899', '9：00 - 18：00');
INSERT INTO `business` VALUES (3, '再清椿美容', '成都市武侯区肖家河大厦', '源码美容美发养生馆是集美容.美发.纹绣.养生为一体的专业服务团队。一楼美发厅拥有专业发型设计师8人为您提供新潮时尚的发型设计', '028-35647877', '9：00 - 18：00');
INSERT INTO `business` VALUES (4, '珍妮优健康美容连锁', '成都市武侯区肖家河大厦', '源码美容美发养生馆是集美容.美发.纹绣.养生为一体的专业服务团队。一楼美发厅拥有专业发型设计师8人为您提供新潮时尚的发型设计', '028-35647877', '9：00 - 18：00');
INSERT INTO `business` VALUES (5, 'Variety沃沙龙·染烫专家', '成都市武侯区肖家河大厦十大大苏打', '源码美容美发养生馆是集美容.美发.纹绣.养生为一体的专业服务团队。一楼美发厅拥有专业发型设计师8人为您提供新潮时尚的发型设计', '028-35647877', '9：00 - 18：00');
INSERT INTO `business` VALUES (6, '源码美容美发5', '成都市武侯区肖家河大厦', '源码美容美发养生馆是集美容.美发.纹绣.养生为一体的专业服务团队。一楼美发厅拥有专业发型设计师8人为您提供新潮时尚的发型设计', '028-35647877', '9：00 - 18：00');
INSERT INTO `business` VALUES (7, '源码美容美发6', '成都市武侯区肖家河大厦', '源码美容美发养生馆是集美容.美发.纹绣.养生为一体的专业服务团队。一楼美发厅拥有专业发型设计师8人为您提供新潮时尚的发型设计', '028-35647877', '9：00 - 18：00');
INSERT INTO `business` VALUES (8, '源码美容美发7学的是d\'s', '成都市武侯区肖家河大厦', '源码美容美发养生馆是集美容.美发.纹绣.养生为一体的专业服务团队。一楼美发厅拥有专业发型设计师8人为您提供新潮时尚的发型设计', '028-35647877', '9：00 - 18：00');
INSERT INTO `business` VALUES (9, '源码美容美发8', '成都市武侯区肖家河大厦', '源码美容美发养生馆是集美容.美发.纹绣.养生为一体的专业服务团队。一楼美发厅拥有专业发型设计师8人为您提供新潮时尚的发型设计', '028-35647877', '9：00 - 18：00');
INSERT INTO `business` VALUES (11, '源码美容美发11', '成都市武侯区肖家河大厦', '源码美容美发养生馆是集美容.美发.纹绣.养生为一体的专业服务团队。一楼美发厅拥有专业发型设计师8人为您提供新潮时尚的发型设计', '028-35647877', '9：00 - 18：00');
...
CREATE TABLE `image`  (
  ...
  `imageurl` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片路径',
  `imagetitle` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片标题',
  `imagetype` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片类型 banner：首页轮播图 nav：菜单 head：头像',
  `imagestate` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片状态  1：可用  0：不可用',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `image` VALUES (10, 'b1.png', '源码美容美发商家', 'bus', '1');
...
INSERT INTO `image` VALUES (165, 'project/3fb718e7-ebd9-4066-84ba-5a3ccdab3273.png', '产品', 'pro', '1');
...
CREATE TABLE `order`  (
  ...
  `openid` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '关联user表的openId',
  `proname` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '项目名称',
  `makedate` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '预约时间',
  `username` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '预约客户姓名',
  `orderstate` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '预约状态',
  `placedate` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '下单时间',
  `usertell` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '手机号',
  `information` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '留言',
  `busid` bigint NOT NULL COMMENT '关联商家id',
  `proid` bigint NOT NULL DEFAULT 0 COMMENT '关联产品id',
  `tecid` bigint NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of order
-- ----------------------------
INSERT INTO `order` VALUES (3, 49, 'oFCod5DOVTGHt5Qx0_bt2_ddYWEI', '美甲豪华套餐', '2021-07-0316:31', 'wrw', '2', '2021-07-03', '1231312', 'wrwer', 2, 3, NULL);
INSERT INTO `order` VALUES (5, 49, 'oFCod5DOVTGHt5Qx0_bt2_ddYWEI', '纯色甲油胶＋磨砂', '2021-07-0316:49', '', '1', '2021-07-03', '', '', 2, 1, NULL);
INSERT INTO `order` VALUES (6, 49, 'oFCod5DOVTGHt5Qx0_bt2_ddYWEI', '【美甲】单人纯色植物甲油胶', '2021-08-0509:41', '赵云', '1', '2021-07-05', '18758878988', '哈哈哈哈哈哈', 2, 2, NULL);
INSERT INTO `order` VALUES (7, 49, 'oFCod5DOVTGHt5Qx0_bt2_ddYWEI', '蛋糕甲油胶纯色+手部SPA', '2021-07-0609:43', '小貂蝉', '1', '2021-07-05', '13666666666', '呵呵呵呵', 2, 3, NULL);
INSERT INTO `order` VALUES (8, 49, 'oFCod5DOVTGHt5Qx0_bt2_ddYWEI1', '蛋糕甲油胶纯色+手部SPA', '2021-07-0509:44', '大乔', '1', '2021-07-05', '14567876543', '大乔大大大', 2, 2, NULL);
INSERT INTO `order` VALUES (16, 49, 'oFCod5DOVTGHt5Qx0_bt2_ddYWEI1', '【CND手护】美国CND深层滋养手部护理', '2021/07/07 0:00', '噢噢噢噢', '1', NULL, '18848428085', '噢噢噢噢', 2, 4, NULL);
INSERT INTO `order` VALUES (17, 49, 'oFCod5DOVTGHt5Qx0_bt2_ddYWEI', '纯色甲油胶＋磨砂', '2021-7-9 9:00', '李四', '0', '2021-07-10', '17883681836', '全额全额委屈', 2, 1, NULL);
INSERT INTO `order` VALUES (19, 49, 'oFCod5DOVTGHt5Qx0_bt2_ddYWEI', '纯色甲油胶＋磨砂', '2021-07-22 09:02', '测试', '0', NULL, '34324234', '阿发发士大夫的', 2, 1, NULL);
INSERT INTO `order` VALUES (20, 49, 'oFCod5DOVTGHt5Qx0_bt2_ddYWEI', '纯色甲油胶＋磨砂', '2021-7-21 9:00', '的合法的身份', '0', '2021-07-21', '453534', 'aa大撒大撒', 2, 1, NULL);
INSERT INTO `order` VALUES (27, 49, 'undefined', '纯色甲油胶＋磨砂', '2021-7-21 9:00', '', '0', '2021-07-22', '', '', 2, 1, NULL);
INSERT INTO `order` VALUES (28, 49, 'oFCod5COAhtK4uSf4FAXD1XWQf6c', '纯色甲油胶＋磨砂', '2021-7-21 9:00', '', '0', '2021-07-22', '', '', 2, 1, NULL);
INSERT INTO `order` VALUES (29, 49, 'oFCod5COAhtK4uSf4FAXD1XWQf6c', '美甲豪华套餐', '2021-7-21 9:00', 'bbq', '0', '2021-07-22', '123456', '阿巴', 2, 3, NULL);
INSERT INTO `order` VALUES (30, 49, 'oFCod5Mm6-4z9VDrKV4yx_rKs1SI', '纯色甲油胶＋磨砂', '2021-07-22 15:26', '', '0', '2021-07-22', '', '', 2, 1, NULL);
INSERT INTO `order` VALUES (31, 49, 'oFCod5Mm6-4z9VDrKV4yx_rKs1SI', '纯色甲油胶＋磨砂', '2021-07-22 16:34', '为', '0', '2021-07-22', '1213', '1', 2, 1, NULL);
INSERT INTO `order` VALUES (32, 49, 'oFCod5Mm6-4z9VDrKV4yx_rKs1SI', '【CND手护】美国CND深层滋养手部护理', '2021-07-22 16:34', '谭爱明', '0', '2021-07-22', '134214214', '12321', 2, 4, NULL);
INSERT INTO `order` VALUES (33, 49, 'oFCod5Mm6-4z9VDrKV4yx_rKs1SI', '蛋糕甲油胶纯色+手部SPA', '2021-07-22 16:45', '恶趣味', '0', '2021-07-22', '1', '1', 2, 2, NULL);
INSERT INTO `order` VALUES (34, 49, 'oFCod5Mm6-4z9VDrKV4yx_rKs1SI', '纯色甲油胶＋磨砂', '2021-07-22 16:54', '谭爱明', '0', '2021-07-22', '112421242', '2112', 2, 1, NULL);
INSERT INTO `order` VALUES (35, 49, 'oFCod5DOVTGHt5Qx0_bt2_ddYWEI', '碧柔发型烫染优惠', '2021-08-06 10:00', '赵小六', '0', '2021-08-05', '18888888888', '需要xxx服务', 4, 14, 15);
INSERT INTO `order` VALUES (36, 49, 'oFCod5DOVTGHt5Qx0_bt2_ddYWEI', '小气泡深层清洁十仪器灌肤', '2021-08-06 9:00', '小陈', '0', '2021-08-05', '17865555555', '啊大大', 3, 7, 7);
INSERT INTO `order` VALUES (37, 49, 'oynkS5nR3I1dZDfC9-RIb0z98ucQ', '纯色甲油胶＋磨砂2', '2023-06-21 09:00:00.0', '大蛤蟆', '0', '2023-06-20 17:41:02.76', '15678946125', '我说一只悲伤的大蛤蟆', 2, 1, NULL);
INSERT INTO `order` VALUES (38, 49, 'oynkS5nR3I1dZDfC9-RIb0z98ucQ', '纯色甲油胶＋磨砂2', '2023-06-21 12:00:00.0', '1`111', '0', '2023-06-21 10:20:05.777', '111111111', '111111111', 2, 1, NULL);
...
CREATE TABLE `project`  (
  ...
  `proexplain` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '项目介绍',
  `proprice` double(8, 2) NULL DEFAULT 0.00 COMMENT '项目价格',
  `prostep` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '项目步骤',
  `protypeid` bigint NULL DEFAULT NULL COMMENT '关联项目类型id',
  `proname` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '项目名称',
  `imageid` bigint NULL DEFAULT NULL COMMENT '关联图片id',
  `prostatus` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '项目状态',
  `busid` bigint NULL DEFAULT NULL COMMENT '关联公司id',
  `tecid` bigint NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of project
-- ----------------------------
INSERT INTO `project` VALUES (1, '甲油胶的成份,甲油胶的主要成分,甲油胶的配方,技术支持,微谱技术分析,提供各类产品检测,独立实验室,仪器齐全,全新配方分析,专业成分分析报告,', 88.00, '1：消毒美甲师的手和客人的手123\n\n2：与客人共同设计适合甲型并修甲型\n\n3：修剪死皮，祛除多余角质，护理指缘\n\n4：根据自己喜好选色，试色\n\n5：涂抹底胶\n\n6：涂抹色胶\n\n7：款式设计\n\n8：涂抹加固\n\n9：涂抹封层\n\n10：对已做好的指甲进行检查\n\n11：清洁手部\n\n12：OPI指缘油护理\n\n13：保湿手霜护理', 3, '纯色甲油胶＋磨砂2', 11, '0', 2, NULL);
...
INSERT INTO `project` VALUES (104, '预约的时候可以说，姐您的护理时间到了，您看今天还是明天来美容院做护理。', 688.00, '如果客户拒绝的话，你可以说上次讲：第一次表皮补水约，第二次真皮补水约，第三次皮下水库约，第四次锁水约。美容要讲究循序渐进，不能中断，那样是效果不好的。', 1, '美容院如何预约客户', 165, '1', 3, NULL);
...
CREATE TABLE `projecttype`  (
  ...
  `name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '项目类型',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `t_employee` VALUES (2, '沸羊羊', 19, '11545685155');
INSERT INTO `t_employee` VALUES (3, '懒羊羊', 15, '11549635155');
INSERT INTO `t_employee` VALUES (4, '张三三', 22, '11189655155');
INSERT INTO `t_employee` VALUES (5, '李四四', 23, '16894571236');
INSERT INTO `t_employee` VALUES (6, '王可可', 20, '15978641236');
INSERT INTO `t_employee` VALUES (7, '懒羊羊', 15, '11549635155');
...
CREATE TABLE `technician`  (
  ...
  `techexplain` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '技师简介',
  `techname` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '技师姓名',
  `busid` bigint NULL DEFAULT NULL COMMENT '关联商家id',
  `imageurl` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '技师头像路径',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `technician` VALUES (31, '陈大山炮为你带来非一般的体验哈哈哈', '陈渝晋', 5, 'technician/6bf0aef0-c898-45f1-ab11-4d7c0ae35922.png');
...
CREATE TABLE `tecpro`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tecid` bigint NULL DEFAULT NULL,
  `proid` bigint NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `tecpro` VALUES (135, 29, 2);
INSERT INTO `tecpro` VALUES (136, 29, 10);
INSERT INTO `tecpro` VALUES (137, 29, 14);
INSERT INTO `tecpro` VALUES (283, 31, 1);
INSERT INTO `tecpro` VALUES (284, 31, NULL);
INSERT INTO `tecpro` VALUES (285, 31, NULL);
INSERT INTO `tecpro` VALUES (286, 31, NULL);
INSERT INTO `tecpro` VALUES (287, 31, NULL);
INSERT INTO `tecpro` VALUES (288, 31, NULL);
INSERT INTO `tecpro` VALUES (289, 31, NULL);
INSERT INTO `tecpro` VALUES (290, 31, NULL);
INSERT INTO `tecpro` VALUES (291, 31, NULL);
INSERT INTO `tecpro` VALUES (292, 31, NULL);
INSERT INTO `tecpro` VALUES (293, 31, NULL);
INSERT INTO `tecpro` VALUES (294, 31, NULL);
INSERT INTO `tecpro` VALUES (295, 31, NULL);
INSERT INTO `tecpro` VALUES (296, 31, NULL);
INSERT INTO `tecpro` VALUES (297, 31, NULL);
INSERT INTO `tecpro` VALUES (298, 31, NULL);
INSERT INTO `tecpro` VALUES (299, 31, NULL);
INSERT INTO `tecpro` VALUES (300, 31, NULL);
INSERT INTO `tecpro` VALUES (301, 31, NULL);
INSERT INTO `tecpro` VALUES (302, 31, NULL);
INSERT INTO `tecpro` VALUES (303, 31, NULL);
INSERT INTO `tecpro` VALUES (304, 31, NULL);
INSERT INTO `tecpro` VALUES (305, 31, NULL);
INSERT INTO `tecpro` VALUES (306, 31, NULL);
INSERT INTO `tecpro` VALUES (307, 31, NULL);
INSERT INTO `tecpro` VALUES (308, 31, NULL);
INSERT INTO `tecpro` VALUES (309, 31, NULL);
INSERT INTO `tecpro` VALUES (310, 31, NULL);
INSERT INTO `tecpro` VALUES (311, 31, NULL);
INSERT INTO `tecpro` VALUES (312, 31, NULL);
INSERT INTO `tecpro` VALUES (313, 31, NULL);
INSERT INTO `tecpro` VALUES (314, 31, 34);
INSERT INTO `tecpro` VALUES (315, 31, NULL);
INSERT INTO `tecpro` VALUES (316, 31, NULL);
INSERT INTO `tecpro` VALUES (317, 31, NULL);
INSERT INTO `tecpro` VALUES (318, 31, NULL);
INSERT INTO `tecpro` VALUES (319, 31, NULL);
INSERT INTO `tecpro` VALUES (320, 31, NULL);
INSERT INTO `tecpro` VALUES (321, 31, NULL);
INSERT INTO `tecpro` VALUES (322, 31, NULL);
INSERT INTO `tecpro` VALUES (323, 31, NULL);
INSERT INTO `tecpro` VALUES (324, 31, NULL);
INSERT INTO `tecpro` VALUES (325, 31, NULL);
INSERT INTO `tecpro` VALUES (326, 31, NULL);
INSERT INTO `tecpro` VALUES (327, 31, 5);
INSERT INTO `tecpro` VALUES (328, 31, 6);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (7, '哈哈哈', 'oFCod5DOVTGHt5Qx0_bt2_ddYWEI', 'https://thirdwx.qlogo.cn/mmopen/vi_32/AXRG7vypnphvVn7BWanmfbbpSfJqlsOZKDOibdObL6kEVtxwwHicUkej7PtnkELwpYh5T2gSQUiclolxGlibvN63Rw/132', NULL, NULL, NULL, '123', '$2a$10$zXblx9ome.jNUw1ZQXmTEuJRhxachw4MA6vqB.jFCliRCcrvSDMcu');
INSERT INTO `user` VALUES (40, 'Larwance78', 'oFCod5COAhtK4uSf4FAXD1XWQf6c', 'https://thirdwx.qlogo.cn/mmopen/vi_32/PiajxSqBRaEL2EpnDcAN4rPgIulicAruEe2XwQmsVy1KRnjzx9nshwZ7xlYMEcuB86J4AgDGLGekMRnOV2XM9q0g/132', NULL, NULL, NULL, NULL, '$2a$10$zXblx9ome.jNUw1ZQXmTEuJRhxachw4MA6vqB.jFCliRCcrvSDMcu');
INSERT INTO `user` VALUES (41, 'TAM', 'oFCod5CJrSlb8VhGZCnJ-iBsPk7s', 'https://thirdwx.qlogo.cn/mmopen/vi_32/FnfnEco7BdgKxoHHcyvTCXgvKCaygONKKyMRbFsWcI8kqdUuiaworU7lMAiafqa84tu5DEkGg9bUmPj0xa0BwZIg/132', NULL, NULL, NULL, NULL, '$2a$10$zXblx9ome.jNUw1ZQXmTEuJRhxachw4MA6vqB.jFCliRCcrvSDMcu');
INSERT INTO `user` VALUES (42, 'Gy', 'oFCod5Mm6-4z9VDrKV4yx_rKs1SI', 'https://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTLYDdcoKcwVAjHXolSibsJhVBSm6QCSarNcfFPOCicJnL4cZqklNpcS2u00X8wCgFgZeWUpz36RDvrg/132', NULL, NULL, NULL, NULL, '$2a$10$zXblx9ome.jNUw1ZQXmTEuJRhxachw4MA6vqB.jFCliRCcrvSDMcu');
INSERT INTO `user` VALUES (43, '大为u贵', NULL, 'user/deb209d5-e097-4388-a06c-68381a3133e7.png', NULL, NULL, 'admin1', '13698459121', '$2a$10$ZJ1UW75XCKN5XChsKk46fOyQxKblP3HTd2z1LxgpWtBJE2piHlAvm');
INSERT INTO `user` VALUES (44, '哈哈哈', 'oFCod5DOVTGHt5Qx0_bt2_ddYWEI', 'https://thirdwx.qlogo.cn/mmopen/vi_32/AXRG7vypnphvVn7BWanmfbbpSfJqlsOZKDOibdObL6kEVtxwwHicUkej7PtnkELwpYh5T2gSQUiclolxGlibvN63Rw/132', 'kE5hx2KRlvhsXCXXpI0SXA==', '562f8056ba69f867fd244bee8ffd4096', 'admin2', '16689751356', '$2a$10$zXblx9ome.jNUw1ZQXmTEuJRhxachw4MA6vqB.jFCliRCcrvSDMcu');
INSERT INTO `user` VALUES (49, '。。。', 'oynkS5nR3I1dZDfC9-RIb0z98ucQ', 'https://thirdwx.qlogo.cn/mmopen/vi_32/DYAIOgq83eoTkuGic6sj0j9xRRFqOd1vCXN4Jzbac4GuSaGCJ6e8wYZibx8VJjDD8wp22ObH7u3wbbpgwrG2kavw/132', 'DNffTUdu9KCMriDjKLzeHg==', NULL, 'wyx', '15523083645', '$2a$10$zXblx9ome.jNUw1ZQXmTEuJRhxachw4MA6vqB.jFCliRCcrvSDMcu');
